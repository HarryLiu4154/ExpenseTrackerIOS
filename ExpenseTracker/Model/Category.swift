...
extension Category {
    ...
    static let travel = Category(id: 103, name: "Travel", icon: .plane_departure, mainCategoryId: 1)
    static let mobilePhone = Category(id: 201, name: "Mobile Phone", icon: .mobile_alt, mainCategoryId: 2)
    static let movieAndDVDs = Category(id: 301, name: "Movies & DVDs", icon: .film, mainCategoryId: 3)
    static let videoGames = Category(id: 302, name: "Video Games", icon: .gamepad, mainCategoryId: 3)
    ...
    static let drinks = Category(id: 503, name: "Drinks", icon: .cocktail, mainCategoryId: 5)
    ...
    static let clothing = Category(id: 802, name: "Clothing", icon: .tshirt, mainCategoryId: 8)
    static let electronics = Category(id: 803, name: "Electronics", icon: .tv, mainCategoryId: 8)
